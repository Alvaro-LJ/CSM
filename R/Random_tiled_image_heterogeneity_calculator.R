...
#'
#' @details
#' The function is aimed to estimate impact of the Modifiable areal unit (MAU). For a given set of tiled images generated using random parameters, the function will compute by-tile heterogeneity metrics in a similar
