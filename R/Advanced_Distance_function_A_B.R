#' Calculates distance between two cell types for a given image
#'
...
#'
#' @details
#' Used in [Distance_matrix_generator()]
#'
#'
#' @returns A tibble containing the distance matrix. Rows represent Cells of Origin and columns represent Target cells.
#' @keywords Internal

Advanced_Distance_function_A_B <-
  function(DATA,
           cell_A,
           cell_B){
