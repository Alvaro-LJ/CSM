...
#' The original data source is [CSM_RAWcellfeaturedata_test()].
#'
#'
#' @docType data
#' @keywords datasets
#' @name CSM_DistanceToPixelcell_test
#' @usage data(CSM_DistanceToPixelcell_test)
#' @format A data frame with 1047 rows and 9 variables
NULL
