#' Calculates distance between two cell types and a cell of origin for a given image selecting a random cell of origin
#'
...
#'
#' @details
#' Used in [Trio_Random_Distance_matrix_generator()]
#'
#'
#' @returns A list containing two tibbles. Tibble A_to_B contains the distance matrix between the single COO and Target cell 1. Tibble A_to_C contains the distance matrix between the single COO and Target cell 2
#' @keywords Internal
