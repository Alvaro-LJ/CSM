...
Pixel analysis may be required for extra-cellular features (for example measuring collagen proteins).
There are two main approaches to perform pixel analysis in CSM. First, pixels can be thresholded and quantified. 
